...
-- rather than only in spelling. SQLite has no GIN and gets a plain index, which cannot serve containment
...
CREATE INDEX idx_events_topics ON events USING GIN (topics_json);
