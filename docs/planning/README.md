...
`pulsar-core` applies the same policy, with `docs/planning/` in its `.gitignore`.
...
- `requirements.md`, project-wide standards across both repos
- `system-prompt.md`, the build guide, with the numbered build sequence in section 12
- `roadmap-product.md`, product context across both repos
